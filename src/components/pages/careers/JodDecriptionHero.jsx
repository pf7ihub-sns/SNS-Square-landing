        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-6 sm:gap-0 pr-4 sm:pr-8 lg:pr-24 relative z-10">
          ...
          <div className="flex flex-col items-start sm:items-start">
            ...
            <div className="flex space-x-1 sm:space-x-1.5">
              {/* Copy Link */}
              <div className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-[#D1DFFA] rounded-full cursor-pointer hover:bg-violet-300 transition-colors flex items-center justify-center">
