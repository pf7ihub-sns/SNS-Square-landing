...
const JobDescriptionHero = ({ currentPage = "description", jobTitle = "UI/UX Designer" }) => {
  ...
  return (
    <div className="w-full pt-20 sm:pt-28 lg:pt-34 pb-6 sm:pb-8">
      <div className="w-full max-w-[1440px] px-4 sm:pl-4 lg:pl-8 justify-center mx-auto">
        {/* Breadcrumb Navigation */}
        <nav className="flex items-center text-xs sm:text-sm text-zinc-600 mb-6 sm:mb-8">
          <span 
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-6 sm:gap-0 pr-4 sm:pr-8 lg:pr-24">
          {/* Left Side - Job Info */}
          <div className="flex-1">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-neutral-950 mb-2 sm:mb-3 leading-tight font-['Manrope']">
              {currentPage === "application" ? `${jobTitle}` : jobTitle}
            </h1>
            <p className="text-base sm:text-lg lg:text-xl text-black font-medium font-['Manrope']">
          ...
          <div className="flex flex-col items-start sm:items-start">
            ...
            <div className="flex space-x-1 sm:space-x-1.5">
              ...
              {/* Copy Link Icon */}
              <div className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-violet-200 rounded-full cursor-pointer hover:bg-violet-300 transition-colors flex items-center justify-center">
