...
const JobDescriptionHero = ({ currentPage = "description", jobTitle = "UI/UX Designer" }) => {
  ...
  return (
    <div className="w-full pt-20 sm:pt-28 lg:pt-34 pb-6 sm:pb-8 relative">
      ...
      <div className="w-full max-w-[1440px] px-4 sm:pl-4 lg:pl-8 justify-center mx-auto relative z-10">
