      ...
      <main className="flex-1 flex items-start justify-center px-4 sm:px-6 lg:px-8 pb-12 pt-8">
        <div className="w-full max-w-4xl">
          ...
          <div className="bg-white border border-slate-200 rounded-lg shadow-md p-8">
            <h2 className="text-lg font-semibold text-slate-900 mb-1">Choose your role</h2>
            <p className="text-xs text-slate-500 mb-5">Select your role to access your personalized Dashboard</p>
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1 bg-slate-50 border border-slate-200 rounded-lg p-6 hover:shadow-md transition-shadow duration-300 flex flex-col">
                <div className="flex items-start gap-3 mb-4 flex-grow">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-slate-900">Doctor</h3>
                    <p className="text-xs text-slate-500">Access your medical dashboard and manage patient care</p>
                  </div>
                </div>
                <button
                  type="button"
              ...
              <div className="flex-1 bg-slate-50 border border-slate-200 rounded-lg p-6 hover:shadow-md transition-shadow duration-300 flex flex-col">
                <div className="flex items-start gap-3 mb-4 flex-grow">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-slate-900">Nurse</h3>
                    <p className="text-xs text-slate-500">Manage patient care and coordinate treatments</p>
                  </div>
                </div>
                <button
                  type="button"
