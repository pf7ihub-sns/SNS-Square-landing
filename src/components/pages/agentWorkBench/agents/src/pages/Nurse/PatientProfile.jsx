...
const PatientProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center mb-4">
            <div>
              ...
              <p className="text-[#64748B] text-sm">{patientData.fullName} - ID: {patientData.patientId}</p>
            </div>
              ...
              {!editMode ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="bg-[#E2E8F0] hover:bg-[#CBD5E1] text-[#475569] font-medium py-2 px-4 rounded transition"
                    disabled={loading}
                  >
                    <i className="fas fa-times mr-2"></i> Cancel
                  </button>
          ...
          <div className="flex border-b border-[#E2E8F0] overflow-x-auto">
            {tabs.map(tab => (
              <button
                ...
                className={`flex items-center px-4 py-3 font-medium transition whitespace-nowrap ${
                  activeTab === tab.id
      ...
      {/* Footer Actions */}
      <div className="bg-white border-t border-[#E2E8F0] sticky bottom-0 z-30">
