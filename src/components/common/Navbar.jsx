          ...
          {isAuthenticated ? (
            ...
            <>
              <Button
                variant="secondary"
                size="small"
                className="rounded px-6 py-2 text-sm font-bold font-manrope bg-black text-white hover:bg-gray-800 transition-colors lg:px-4 lg:py-2 lg:text-xs xl:px-6 xl:text-sm"
                onClick={() => {
