...
const HorizontalBlogCard = ({ 
  ...
  return (
    <div 
      className={`group w-full bg-white rounded-lg border border-gray-200 overflow-hidden cursor-pointer hover:shadow-lg transition-shadow duration-300 flex h-full ${className}`}
      onClick={onClick}
    >
      ...
      <div className="flex-1 p-4 bg-white flex flex-col justify-between min-w-0">
